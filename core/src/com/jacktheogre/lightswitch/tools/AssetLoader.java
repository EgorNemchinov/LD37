...
public class AssetLoader {
    ...
    public Texture link, zelda, teleport, scale, scale_fill, replay_button, play_button;
    public Texture moon, buttons;
    public TextureRegion undo_button, redo_button, start_button, teleport_button;
    public TiledMap map;
...
//        manager.load();
    ...
    public void load() {
        ...
        play_button = manager.get("play_button.png", Texture.class);
        ...
        teleport_button = new TextureRegion(buttons, 0, 52, 148, 22);
