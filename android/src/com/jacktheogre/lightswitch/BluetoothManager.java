...
import com.jacktheogre.lightswitch.multiplayer.iBluetooth;
			...
			try {
				tmp = getAdapter()
						.listenUsingRfcommWithServiceRecord(
								"CastleCrushGame",
								UUID.fromString("5A37A520-EEE0-11E6-9598-0800200C9A66"));
			} catch (IOException e) {
			}
			mmServerSocket = tmp;
		}
		...
		public ConnectThread(BluetoothDevice device) {
			...
			try {
				tmp = device.createRfcommSocketToServiceRecord(UUID
						.fromString("5A37A520-EEE0-11E6-9598-0800200C9A66"));
			} catch (IOException e) {
			}
			mmSocket = tmp;
		}
